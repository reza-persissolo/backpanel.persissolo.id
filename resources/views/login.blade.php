...
<head>
    ...
    <!-- Page Title  -->
    <title>Login - {{ \App\Helper\Constant::APP_NAME }}</title>
    <!-- StyleSheets  -->
                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        ...
                        <div class="card card-bordered">
                            <div class="card-inner card-inner-lg">
                                ...
                                @csrf
                                    ...
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            ...
                                            <a class="link link-primary link-sm" href="{{ route('resetpassword') }}">Lupa Password?</a>
                                        </div>
                                ...
                                <div class="form-note-s2 text-center pt-4"> Register <a href="{{ route('register') }}">Buat Akun</a>
                                </div>

...
!function (NioApp, $) {
  ...
  var totalDeposit = {
    ...
    datasets: [{
      label: "Active User",
      color: [NioApp.hexRGB("#d63c4d", .2), NioApp.hexRGB("#d63c4d", .2), NioApp.hexRGB("#d63c4d", .2), NioApp.hexRGB("#d63c4d", .2), NioApp.hexRGB("#d63c4d", .2), NioApp.hexRGB("#d63c4d", .2), colors.a.base],
      // @v2.0

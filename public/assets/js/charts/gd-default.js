...
!function (NioApp, $) {
  ...
  var salesRevenue = {
    ...
    datasets: [{
      label: "Sales Revenue",
      color: [NioApp.hexRGB("#d63c4d", .2), NioApp.hexRGB("#d63c4d", .2), NioApp.hexRGB("#d63c4d", .2), NioApp.hexRGB("#d63c4d", .2), NioApp.hexRGB("#d63c4d", .2), NioApp.hexRGB("#d63c4d", .2), NioApp.hexRGB("#d63c4d", .2), NioApp.hexRGB("#d63c4d", .2), NioApp.hexRGB("#d63c4d", .2), NioApp.hexRGB("#d63c4d", .2), NioApp.hexRGB("#d63c4d", .2), "#d63c4d"],
      //@v2.0
  ...
  var activeSubscription = {
    ...
    datasets: [{
      label: "Active User",
      color: [NioApp.hexRGB("#d63c4d", .2), NioApp.hexRGB("#d63c4d", .2), NioApp.hexRGB("#d63c4d", .2), NioApp.hexRGB("#d63c4d", .2), NioApp.hexRGB("#d63c4d", .2), "#d63c4d"],
      //@v2.0

...
class Constant{
    ...
    public const GALERY_IMAGE       = 1;
    public const GALERY_VIDEO       = 2;
    ...
    public const MENU_GALERY_IMAGE      = "galery.image";
    public const MENU_GALERY_VIDEO      = "galery.video";

    public const MENU_NEWS              = "news";
    public const MENU_SPONSOR           = "sponsor";
